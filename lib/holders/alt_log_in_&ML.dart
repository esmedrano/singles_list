...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (!docSnap.exists) {
        debugPrint('Creating new profile for user ${user.uid} with data: $data');
        await docRef.set(data);
      } else {
        debugPrint('Updating profile for user ${user.uid} with data: $data');
      ...
      debugPrint('Profile updated successfully for user ${user.uid}');
      ScaffoldMessenger.of(context).showSnackBar(
              ...
              children: [
                ...
                Container(
                  ...
                  child: profileVerified
                      ...
                      : TextButton(
                          onPressed: () => widget.switchPage(5, null), // Navigate to VerificationPage
                          style: TextButton.styleFrom(
