...
//   @override
//   Widget build(BuildContext context) {
//     final menuItemStyle = ButtonStyle(  // Menu Item style
//       // overlayColor: WidgetStateProperty.resolveWith<Color?>(
//       //   (Set<WidgetState> states) => states.contains(WidgetState.pressed)
//       //       ? Color.fromARGB(49, 255, 86, 86) // ~0.2 opacity (51/255)
//       //       : null,
//       // ),
...
//         shape: WidgetStateProperty.all(
//           RoundedRectangleBorder(
//             borderRadius: BorderRadius.circular(20), // Adjust the radius for rounded corners of the trigger button
//           ),
//         ),
//         backgroundColor: WidgetStateProperty.all(const Color.fromARGB(255, 86, 182, 255)), // Optional: Set background color
//         elevation: WidgetStateProperty.all(4), // Optional: Add shadow for better visibility
//       ),

//       // alignmentOffset: const Offset(0, 0), // Adjust this value to center the menu

//       menuChildren: <Widget>[
//         MenuItemButton(onPressed: () {}, style: menuItemStyle, child: Center(child: const Text('Liked'))),
//         MenuItemButton(onPressed: () {}, style: menuItemStyle, child: Center(child: const Text('Disliked'))),
//         MenuItemButton(onPressed: () {}, style: menuItemStyle, child: Center(child: const Text('New'))),
//         MenuItemButton(onPressed: () {}, style: menuItemStyle, child: Center(child: const Text('Distance'))),
//         MenuItemButton(onPressed: () {}, style: menuItemStyle, child: Center(child: const Text('Select'))),
//       ],
